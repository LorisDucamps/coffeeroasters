  ...
  return (
    <section className={`relative ${beforeStyles} mb-[120px]`}>
      <div className="grid grid-cols-1 desktop:grid-cols-2 gap-16">
        <picture className="relative w-full px-6">
          <source
        ...
        <div className="px-6">
          <h3 className="font-fraunces font-black text-[28px] leading-[28px] text-center text-light-cream mb-6 tablet:text-left desktop:text-[40px] desktop:leading-[48px] desktop:text-left">
            Uncompromising quality
          </h3>
          <p className="text-[15px] leading-[25px] text-light-cream text-center tablet:text-left desktop:text-left">
